            ...
            <div className="footer__container">
                <div className="footer__items__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>+91 9159213595</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span style={{fontSize:15}}>m.sudha23ss@gmail.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>Tirunelveli/Tamil Nadu</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul className="footer__social__links">
                            ...
                            <li className="social__link">
    <a href="https://www.instagram.com/_sudha_.exe" target="_blank" rel="noopener noreferrer">
        <InstagramIcon />
    </a>
</li>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2024 Rexy Ltd. |</li>
